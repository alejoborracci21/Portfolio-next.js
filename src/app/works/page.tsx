          ...
          <div className="relative flex w-2/4 h-[50vh] bg-white border border-white ml-10 mt-14 overflow-hidden group">
            <div className="relative flex-1">
              ...
              <p className="absolute content-center bottom-0 left-0 w-full h-full text-black text-l font-serif px-4 py-2 font-bold opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100">
                ...
                desarrollamos con un equipo de 5 personas. En el sitio web, los
                usuarios pueden ver las diferentes prendas disponibles en stock
                y filtrarlas según las características que estén buscando. Si
                desean realizar una compra, tienen la opción de registrarse para
                acceder a una pasarela de pagos y completar la compra deseada.
                Además, la plataforma cuenta con un panel de administración que
                permite editar productos y acceder a las estadísticas del sitio.
              </p>
            </div>
          </div>
          ...
          <div className="relative flex w-2/4 h-[50vh] border border-white bg-white ml-auto mr-10 mt-14 overflow-hidden group">
            <div className="relative flex-1">
              ...
              <p className="absolute font-serif content-center bottom-0 left-0 w-full h-full text-black text-l px-4 py-2 font-bold opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100">
                ...
                sitio web existente. ALK eleva su página web al siguiente nivel
                al ofrecer soluciones rápidas, interfaces de usuario atractivas
                e intuitivas, basándonos en la excelencia técnica y el
                profesionalismo.
              </p>
            </div>
          </div>
          ...
          <div className="relative flex w-2/4 h-[50vh] border border-white bg-white ml-10 mt-14 overflow-hidden group">
            <div className="relative flex-1">
              ...
              <p className="absolute content-center bottom-0 left-0 w-full h-full text-black text-l font-serif px-4 py-2 font-bold opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100">
                ...
                page, luego nos dirigimos a la página principal donde se
                muestran los distintos corredores almacenados en la base de
